...
* internal
  * fix pypi bug on version name (a space at the end of the 0.2.10)
  
## [0.2.10] - 2026-09-23

* internal
  * fix pypi bug on version name (a space at the end of the 0.2.9)
...
* Fix :
  * Bug compute_value on list / tuple return allways changed
...
* Fix :
  * bug fix SFilter doenst use __json_encode__
